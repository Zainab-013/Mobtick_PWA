...
const Men = () => {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    setError("");
    try {
      const res = await axios.get(`${API_BASE}/api/products/men`, { params: buildParams() });
      ...
      console.error("Fetch men products error:", err);
      ...
      <div className="relative min-h-screen bg-gray-100 dark:bg-black/90 text-gray-900 dark:text-white font-sans transition-all duration-500">
        ...
        >
          ...
          <section className="flex-1 p-8">
            <h1 className="text-3xl font-bold mb-6 text-center">Men’s Watches</h1>
            {loading ? (
